...
def simpson_integral_from_points(points):
    func_sum = 0
...
def main():
    ...
    sin_integral = simpson_integral_from_points(chosen_points)
    sin_integral_theoretical_error = (((b - a) ** 5) / (180 * N ** 4))
    arithmetical_error = sin_integral - 1

    print("Sin integral in [0, pi/2] with Simpson from 11 chosen points: {:f}".format(sin_integral))
